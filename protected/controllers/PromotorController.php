...
class PromotorController extends CController{
	public $breadcrumbs;
	public $layout='main';
	...
	public function actionIndex(){
		...
		$session['Promotor_records']=Promotor::model()->findAll($criteria);
		$this->render('index',array('model'=>$model,));

	}

	public function loadModel($id){
		$model=Promotor::model()->findByPk($id);
		if($model===null)
	...
	public function actionGeneratePdf(){
		...
		if(isset($session['Promotor_records']))
			$model=$session['Promotor_records'];
		else
			$model = Promotor::model()->findAll();
		$html = $this->renderPartial('expenseGridtoReport', array('model'=>$model), true);
		//die($html);
		$pdf = new TCPDF();
		$pdf->SetCreator(PDF_CREATOR);
		$pdf->SetAuthor(Yii::app()->name);
		$pdf->SetTitle('Promotor Report');
		$pdf->SetSubject('Promotor Report');
