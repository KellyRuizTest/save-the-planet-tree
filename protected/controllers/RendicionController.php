...
class RendicionController extends CController
{
        public $breadcrumbs;
	/**
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Rendicion'];
			if($model->save())
	...
	public function actionIndex()
	{
		...
		{
                        $model->attributes=$_GET['Rendicion'];
                 ...
                 $session['Rendicion_records']=Rendicion::model()->findAll($criteria); 
	...
	{
		$model=Rendicion::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rendicion-form')
		{
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Rendicion_records']))
               {
                $model=$session['Rendicion_records'];
               }
               else
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Rendicion Report');
		$pdf->SetSubject('Rendicion Report');
		...
		$pdf->LastPage();
		$pdf->Output("Rendicion_002.pdf", "I");
	}
}
